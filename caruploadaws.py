...
def insert_car_details(car_name, segment_id, segment_name, model_type, year, engine_type, fuel_type, price, image_urls, cursor):
    try:
        ...
        cursor.execute("""
            INSERT INTO car (car_name, segment_id, segment_name, model_type, year, engine_type, fuel_type, price,
...
def upload_car():
    ...
    try:
        conn = pyodbc.connect(
            ...
            f"Server={db_config['server']},1433;Database={db_config['database']};"
